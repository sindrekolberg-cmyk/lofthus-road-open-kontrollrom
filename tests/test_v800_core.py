...
BOOTSTRAP = {
    ...
    "elements": [
        {"id": 10, "web_name": "Isak", "first_name": "Alexander", "second_name": "Isak", "team": 1, "element_type": 4, "now_cost": 100, "total_points": 20, "selected_by_percent": "30.0"},
        {"id": 20, "web_name": "Haaland", "first_name": "Erling", "second_name": "Haaland", "team": 2, "element_type": 4, "now_cost": 145, "total_points": 20, "selected_by_percent": "60.0"},
    ],
}
...
class V800CoreTests(unittest.TestCase):
    def setUp(self):
